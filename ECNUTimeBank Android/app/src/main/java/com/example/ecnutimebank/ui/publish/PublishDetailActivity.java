...
public class PublishDetailActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        etDescription =(MaterialEditText)findViewById(R.id.et_description);
        etTel = (MaterialEditText)findViewById(R.id.et_tel);
        etTime = (MaterialEditText)findViewById(R.id.et_time);
    ...
    private void setListener(){
        ...
        bt_publish.setOnClickListener(view -> {
            ...
            publish(name,time,telephone,address,description,type);
    ...
    private void publish(String name,String time,String telephone,String address,String description,String type){
